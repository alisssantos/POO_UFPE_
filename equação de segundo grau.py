...
class SegundoGrau:
	...
	def analise_delta(self):
		...
		#coloquei a variavel txt como global para poder fazer a gambiarra com o tkinter
		# e atribuir ao campo txt no Label texto1
		global txt
		...
		if delta > 0:
			...
			#gambiarra texto1
			txt = (f'A função f(a) = duas raizes reais, x1 = {x1}, e x2 = {x2}')
		elif delta == 0:
			#coloquei a variavel txt como global para poder fazer a gambiarra com o tkinter
			# e atribuir ao campo txt no Label texto2
			global txt1
			...
			#gambiarra texto2
			txt1 = (f'A função tem duas raizes reais iguais, x1 = {x} x2 = {x} ')
		else:
			#coloquei a variavel txt como global para poder fazer a gambiarra com o tkinter
			# e atribuir ao campo txt no Label texto2
			global txt2
			...
			#gambiarra texto2
			txt2 = (f'a função tem duas raizes complexas, x1 = {z_real:.2f} + {z_imag:.3f} *i e x2 = {z_real:.2f} - {z_imag:.3f} *i')
